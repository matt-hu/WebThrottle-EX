...
function trainlinkSetSpeed(address, speed, direction=-1) { 
...
function trainlinkStopCab(address) {
...
function trainlinkEstopCab(address) {
	/*	adress: the address of the cab to stop */
...
function trainlinkSendCommand(command) {
...
function trainlinkSetPower(state) {
